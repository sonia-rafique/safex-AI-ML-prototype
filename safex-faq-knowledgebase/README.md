...
1. [Project Overview and Executive Summary](https://www.google.com/search?q=%231-project-overview-and-executive-summary)
2. [System Architecture and Design](https://www.google.com/search?q=%232-system-architecture-and-design)
3. [Detailed Component Breakdown](https://www.google.com/search?q=%233-detailed-component-breakdown)
4. [Source Code and File Structure](https://www.google.com/search?q=%234-source-code-and-file-structure)
5. [Setup and Execution Instructions](https://www.google.com/search?q=%235-setup-and-execution-instructions)
6. [API Validation and Payload Schemas](https://www.google.com/search?q=%236-api-validation-and-payload-schemas)
...
* **Windows Command Prompt:** `set GEMINI_API_KEY=your_actual_api_key_here`
* **macOS / Linux Terminal:** `export GEMINI_API_KEY="your_actual_api_key_here"`
